                          ...
                          <>
                            {
                              ...
                              transfer.applyCommission ?(<>
                                      ...
                                      <div className="form-row">
                                          ...
                                          <FormGroup className="col-md-8">
                                              <p className="form-control-static">{transfer.commission.commissionRate+" "}<span></span></p>
                                          </FormGroup>
                                      </div>
                                      ...
                                      <div className="form-row">
                                          ...
                                          <FormGroup className="col-md-8">
                                              <p className="form-control-static"> {transfer.commission.tvaRate+" "}<span></span></p>
                                          </FormGroup>
                                      </div>
                              </>):
                                  <>
                                      <div className="form-row">
                                          ...
                                          <FormGroup className="col-md-8">
                                              <p className="form-control-static">Non</p>
                                          </FormGroup>
                                      </div>
                                  </>
                                  }
                                ...
                                <div className="form-row">
                                    ...
                                    <FormGroup className="col-md-8">
                                      <p className="form-control-static">{transfer.amount+" "}<span>{transfer.transactionCurrency.name}</span></p>
                                    </FormGroup>
                                </div>
                                ...
                                <div className="form-row">
                                  ...
                                  {transfer.state.code==='4000' && this.props.currentUser.role==="ROLE_AGENT"?(
                                      <div className="form-row">
                                          <Label className={"col-md-4 col-form-label"}>Motif de l'annulation</Label>
                                          <FormGroup className="col-md-8">
